...
\title{A Visualization Framework to Improve and Streamline Equities Analysis for Portfolios}

\submitted{April 2017}  % degree conferral date (January, April, June, September, or November)
...
\include{ch-visualizer/chapter-visualizer}
\include{ch-al/chapter-al}
\include{ch-gc/chapter-gc}
