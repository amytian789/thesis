...
\begin{longtable}{p{0.3\linewidth} p{0.3\linewidth} p{0.3\linewidth}}
	...
	data are uncorrelated. For Dataset 1, refer to Appendix 
	~\ref{sec:appendicies:me1plot}. For Dataset 2, refer to Appendix 
	~\ref{sec:appendicies:me2plot}} \label{tab:intro:me}\\
	\toprule
